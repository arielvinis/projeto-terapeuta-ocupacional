    ...
    <section id="servicos" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div ref={headerRef} className="text-center mb-16">
          ...
          >
            Atendimento especializado para criancas com diferentes necessidades
            de desenvolvimento
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <Image
              ...
              className="object-cover"
            />
            <div className="absolute inset-0 bg-linear-to-r from-foreground/70 to-foreground/40" />
        ...
        >
          ...
          >
            <span
              className={`text-sm tracking-[0.3em] uppercase text-primary mb-4 block ${isAboutVisible ? "animate-blur-in opacity-0" : "opacity-0"}`}
              style={
                isAboutVisible
                  ? { animationDelay: "0.2s", animationFillMode: "forwards" }
                  : {}
            ...
            <h2
              className={`font-serif text-4xl leading-tight text-foreground mb-6 text-balance md:text-5xl ${isAboutVisible ? "animate-blur-in opacity-0" : "opacity-0"}`}
              style={
                isAboutVisible
                  ? { animationDelay: "0.4s", animationFillMode: "forwards" }
                  : {}
            ...
            <p
              className={`text-lg text-muted-foreground leading-relaxed mb-6 ${isAboutVisible ? "animate-blur-in opacity-0" : "opacity-0"}`}
              style={
                isAboutVisible
                  ? { animationDelay: "0.6s", animationFillMode: "forwards" }
                  : {}
